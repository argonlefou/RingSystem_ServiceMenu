...
{    
    public partial class WndMain : Form
    {
        ...
        private const int BACKUP_EEPROM_DIFFICULTY_OFFSET = 0x0B8;
        private const int BACKUP_EEPROM_LIFE_OFFSET = 0x100;
        private const int BACKUP_EEPROM_ADVERTISE_OFFSET = 0x094;
        private const int BACKUP_EEPROM_KIDSMODE_OFFSET = 0x31E;
        private const int BACKUP_EEPROM_DRESSCODE_OFFSET = 0x3AE;

        private const string JCONFIG_EEPROM_PATH = @"\sv\E2PROM.bin";
        private const string BACKUP_EEPROM_PATH = @"\data\Fraw\fwSRAM\fwFormat101_EEP.bin";
        ...
        private const UInt32 JCONFIG_CREDITS_LENGTH = 28;
        private const UInt32 JCONFIG_OPTIONS_OFFSET = 0x122A;
        private const UInt32 JCONFIG_OPTIONS_LENGTH = 260;
        ...
        {
            InitializeComponent();
            this.Text = "Let's Go Island - System Menu v" + System.Reflection.Assembly.GetEntryAssembly().GetName().Version.ToString();
        }
        ...
        private void WndMain_Load(object sender, EventArgs e)
        {
            ...
            {
                _BackupEepromContent = Lgi_ServiceMenu.Properties.Resources.fwFormat101_EEP;
            }
            else
            {
                try
            ...
            {
                _JconfigEepromContent = Lgi_ServiceMenu.Properties.Resources.E2PROM;
            }
            else
            {
                try
